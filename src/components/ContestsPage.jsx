                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          {contest.status === 'upcoming' && !contest.registered && (
                            <Button onClick={() => handleContestAction(contest.id, 'register')} className="btn-premium hover-glow">
                              <Trophy className="w-4 h-4 mr-2" />
                              Register Now
                            </Button>
                          )}
                          {contest.status === 'ongoing' && contest.registered && (
                            <Button onClick={() => handleContestAction(contest.id, 'continue')} className="btn-premium hover-glow">
                              <Play className="w-4 h-4 mr-2" />
                              Continue Contest
                            </Button>
                          )}
                          {contest.status === 'ongoing' && !contest.registered && (
                            <Button onClick={() => handleContestAction(contest.id, 'participate')} className="btn-premium hover-glow">
                              <Play className="w-4 h-4 mr-2" />
                              Join Now
                            </Button>
                          )}
