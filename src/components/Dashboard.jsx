                      ...
                      <>
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            ...
                            <h3 className="text-xl font-semibold mb-3 text-slate-800 group-hover:text-orange-600 transition-colors">
                              {item.title}
                            </h3>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                          <div className="text-center">
                            <div className="text-lg font-bold text-purple-600">{item.participants}</div>
                            <div className="text-xs text-slate-500">Participants</div>
                          </div>
                          <div className="text-center">
                            <div className="text-lg font-bold text-emerald-600">{item.prize}</div>
                          ...
                          <div className="text-center">
                            <div className="text-lg font-bold text-blue-600">{item.difficulty}</div>
                            <div className="text-xs text-slate-500">Difficulty</div>
                          </div>
                        </div>
                        <Button className="w-full btn-premium hover-glow" onClick={() => onNavigate('contests')}>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="glass border-white/20 shadow-elegant animate-fade-in-up">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-500">XP Points</span>
                    <span className="text-xl font-bold text-purple-600">{user.xp}</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xl font-bold text-orange-600">{user.streak} 🔥</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-500">Badges</span>
                    <span className="text-xl font-bold text-emerald-600">{user.badges}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {notifications.slice(0, 3).map((notification) => (
                    <div key={notification.id} className={`p-3 rounded-lg transition-all hover-lift cursor-pointer ${!notification.read ? 'bg-blue-50 border border-blue-200' : 'bg-slate-50'}`}>
            ...
            <Card className="glass border-white/20 shadow-elegant animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              ...
              <CardContent className="space-y-3">
                <Button variant="outline" className="w-full justify-start btn-glass hover-lift" onClick={() => onNavigate('join-groups')}>
                  <Users className="w-4 h-4 mr-3" />
                  Join Study Groups
                </Button>
                <Button variant="outline" className="w-full justify-start btn-glass hover-lift" onClick={() => onNavigate('notes')}>
                  <BookOpen className="w-4 h-4 mr-3" />
                  Browse Notes
                </Button>
                <Button variant="outline" className="w-full justify-start btn-glass hover-lift" onClick={() => onNavigate('contests')}>
